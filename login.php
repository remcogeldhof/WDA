                ...
                <div class="col-md-8 w3_agile_mail_grid">
                    <div class="col-md-13 w3_agile_mail_grid">
						<span class="input input--ichiro">
							<input class="input__field input__field--ichiro" name="gebruikersnaam" type="text" id="input-25" placeholder=" " required="" />
                        ...
                        <span class="input input--ichiro">
							<input class="input__field input__field--ichiro" name="wachtwoord" type="password" id="input-26" placeholder=" " required="" />
                    ...
                    <a href="createaccount.php" class="btn btn-default">Create Account</a>
                </div>
