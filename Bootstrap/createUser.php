...
<form method="post" name="login" action="../Bootstrap/createUserVerwerking.php">
    ...
    <input type="text" name="mail" class="form-control" id="mail" placeholder="e-mailadres">
  </div>
    <div class="form-group">
    <label for="username">Gebruikersnaam: </label>
    <input type="text" name="gebruikersnaam" class="form-control" id="username" placeholder="gebruikersnaam">
  </div>
  <div class="form-group">
    <label for="password">Wachtwoord: </label>
    <input type="password" name="wachtwoord" class="form-control" id="password" placeholder="wachtwoord">
  </div>
  <button type="submit" value="login" class="btn btn-default">Maak account</button>
</form>
