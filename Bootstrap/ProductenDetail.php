...
<div class="container">
            ...
            <div class="thumbnail">
                ...
                <div class="caption">
                    <h4 class="group inner list-group-item-heading">
                     ...
                     <p class="group inner list-group-item-text"> <?php echo $huidigProduct->beschrijving; ?>
                       </p>
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6" id="hover-content">
                           <!-- <a class="btn btn-success" href="http://www.jquery2dotnet.com">Add to cart</a>-->
                            ...
                            <input type="hidden" name="pagina" value="ProductenDetail.php">
    ...
    <!-- Template: http://bootsnipp.com/snippets/featured/list-grid-view-->
