...
<div class="container">
    <h3>Je bestelling is succesvol afgerond</h3>
  	<table id="cart" class="table table-hover table-condensed">
    				<thead>
						<tr>
							<th style="width:60%">Product(en)</th>
      ...
      foreach($_SESSION["cart"] as $huidgeId){
        ?>
                ...
                ?>
							...
							<td data-th="Price"><?php echo  ProductDAO::getById($huidgeId)->prijs; ?>
                            <div class="row">
									<div class="col-sm-10">
         ...
         <?php
					...
					<tfoot>
						...
						<tr >
							<td ><a href="index.php" class="btn btn-primary"><i class="fa fa-angle-left"></i>Terug</a></td>
